...
class Main {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            document.getElementById("getBigIntegerFromAssetAmount_do").onclick = () => __awaiter(this, void 0, void 0, function* () {
                var getBigIntegerFromAssetAmount_input = document.getElementById("getBigIntegerFromAssetAmount_input");
                yield this.getBigIntegerFromAssetAmount(JSON.parse(getBigIntegerFromAssetAmount_input.value));
            });
            document.getElementById("getDecimalsFromAssetAmount_do").onclick = () => __awaiter(this, void 0, void 0, function* () {
