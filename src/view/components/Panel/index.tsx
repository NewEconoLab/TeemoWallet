...
export default class Panel extends React.Component<IProps, IState>
{
	...
	public render() {
		let type = ''
		if (this.props.task.sendHistory) { type = this.props.task.sendHistory.fromAddress !== common.account.address && this.props.task.sendHistory.toAddress == common.account.address ? 'input' : 'output' }
		if (this.props.task.type == ConfirmType.claimgas) { type = 'input' }
		return (
			<div className="panel">
				<div className="panel-heading" onClick={this.onClick}>
					...
					{
						(this.props.task.type == ConfirmType.contract) &&
						<div className="transfer-type">
					...
					{
						(this.props.task.type == ConfirmType.deploy) &&
						<div className="transfer-type">
